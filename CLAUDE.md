...
- Direction of truth: live machine → `./save.sh` → repo. Never hand-edit the
  ...
  `claude/`, `notepad++/`, `cmder/`, `vscode/`) — change the live setting, then
  run `./save.sh`. Hand-edited files are only: `save.sh`, `restore.sh`,
  `lib/jsonc-to-json.py`, `README.md`, this file.
